...
function initialize(initialState, options) {
    ...
    if (options.hotLoad === true && options.cache != undefined) {
        ...
        state_1.State.subscribe(function (state) { return __awaiter(_this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs_1.writeFile(cacheFile_1, JSON.stringify(state))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
        ...
        }); }, function (error) { return console.error(error); }, undefined);
    }
    else {
